package com.miniWeb.restAPI.service.user;

import com.google.gson.Gson;
import com.miniWeb.restAPI.advice.exception.CCommunicationException;
...
public class KakaoService {
    ...
    public RetKakaoAuth getKakaoTokenInfo(String code){
        ...
        params.add("client_id", kakaoCliendtId);
